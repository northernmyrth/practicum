...
| [🎓 Выпускной проект]([Выпускной-проект](https://github.com/northernmyrth/practicum/blob/main/Выпускной%20проект-2.ipynb))         | Дипломный проект      | На основе поведения пользователей дать рекомендации по развитию приложения |
